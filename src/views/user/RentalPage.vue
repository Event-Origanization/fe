...
const translatedSteps = computed(() => [
  { icon: 'pi-comments', title: t('RENTAL.STEPS.STEP1_TITLE', 'TƯ VẤN THIẾT BỊ'), desc: t('RENTAL.STEPS.STEP1_DESC', 'Tư vấn lựa chọn thiết bị phù hợp nhất với nhu cầu sự kiện') },
  { icon: 'pi-file-edit', title: t('RENTAL.STEPS.STEP2_TITLE', 'KÝ HỢP ĐỒNG'), desc: t('RENTAL.STEPS.STEP2_DESC', 'Thống nhất các hạng mục và ký kết hợp đồng nhanh chóng') },
  { icon: 'pi-truck', title: t('RENTAL.STEPS.STEP3_TITLE', 'GIAO HÀNG & LẮP ĐẶT'), desc: t('RENTAL.STEPS.STEP3_DESC', 'Đội ngũ kỹ thuật hỗ trợ giao hàng và setup tận nơi') },
  { icon: 'pi-check-circle', title: t('RENTAL.STEPS.STEP4_TITLE', 'NGHIỆM THU'), desc: t('RENTAL.STEPS.STEP4_DESC', 'Kiểm tra hoạt động và nghiệm thu ngay sau khi hoàn thành') }
])
</script>
