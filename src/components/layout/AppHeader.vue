  ...
  >
    <div class="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
      ...
      >
        <button
          @click="handleToggle"
          class="md:hidden flex items-center justify-center w-10 h-10 text-gray-500 border-gray-200 rounded-lg z-99999 dark:border-gray-800 dark:text-gray-400 lg:h-11 lg:w-11 lg:border"
          :class="[
            isMobileOpen
