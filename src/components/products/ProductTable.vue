            ...
            >
              ...
              <td class="px-5 py-4 text-right">
                <div class="flex items-center justify-end gap-2">
                  <button class="p-2 text-blue-500 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-lg transition-colors" title="Chỉnh sửa">
                    <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                    </svg>
                  </button>
                  <button class="p-2 text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg transition-colors" title="Xóa">
                    <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
// Mock Data
const products = ref([
  { id: 1, name: 'Âm thanh sự kiện gói Basic', slug: 'am-thanh-co-ban', price: 3000000, isActive: true, image: 'https://images.unsplash.com/photo-1598488035139-bdbb2231ce04?q=80&w=200&auto=format&fit=crop' },
  { id: 2, name: 'Ánh sáng sân khấu biểu diễn', slug: 'anh-sang-san-khau', price: 5500000, isActive: true, image: 'https://images.unsplash.com/photo-1492684223066-81342ee5ff30?q=80&w=200&auto=format&fit=crop' },
  { id: 3, name: 'Màn hình LED P3 Indoor', slug: 'man-hinh-led-p3', price: 1200000, isActive: false, image: null },
  { id: 4, name: 'MC Tiếng Việt & Anh', slug: 'mc-song-ngu', price: 8000000, isActive: true, image: 'https://images.unsplash.com/photo-1475721027785-f74eccf877e2?q=80&w=200&auto=format&fit=crop' },
  { id: 5, name: 'Trang trí tiệc cưới Luxury', slug: 'trang-tri-cuoi-luxury', price: 25000000, isActive: true, image: 'https://images.unsplash.com/photo-1511795409834-ef04bbd61622?q=80&w=200&auto=format&fit=crop' },
])
...
const filteredProducts = computed(() => {
  return products.value.filter(product => {
    ...
    const matchesStatus = filterStatus.value === 'all' || 
                         (filterStatus.value === 'active' && product.isActive) ||
                         (filterStatus.value === 'inactive' && !product.isActive)
